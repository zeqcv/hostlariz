                ...
                <div class="de-item wow fadeInRight animated"
                    ...
                    <div class="d-overlay" style="background-size: cover; background-repeat: no-repeat;">
                        ...
                        <div class="d-text" style="background-size: cover; background-repeat: no-repeat;">
                            ...
                            <p class="d-price"><span class="price"><?php echo e($game->gamePrice); ?> TL'den Başlayan fiyatlarla...</span></p>
                            <a class="btn-main btn-fullwidth" href="pricing-table-one.html">Sipariş Ver</a>
                        </div>
                    </div>
                    <img src="<?php echo e($game->gameThumbnail); ?>" class="img-fluid slideInUp" alt="" data-wow-delay="0s">
                </div>
            </div>
...
<?php /**PATH E:\Projects\laravel\hostlariz\resources\views/components/Servers.blade.php ENDPATH**/ ?>