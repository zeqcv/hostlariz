    ...
    <div class="v-center" style="background-size: cover; background-repeat: no-repeat;">
        <div class="swiper swiper-initialized swiper-horizontal swiper-watch-progress swiper-backface-hidden"
            ...
            <div class="swiper-wrapper" id="swiper-wrapper" aria-live="off"
                ...
                <div class="swiper-inner bgcustom" data-bgimage="url(<?php echo e($game->gamePhoto); ?>)"
                    style="background: url(<?php echo e($game->gamePhoto); ?>) cover no-repeat;">
                        ...
                        <div class="container" style="background-size: cover; background-repeat: no-repeat;">
                            <div class="row gx-5 align-items-center"
                                ...
                                <div class="col-lg-8 mb-sm-30"
                                    ...
                                    <h1 class="slider-title text-uppercase mb-1"><?php echo e($game->gameName); ?></h1>
                                </div>
                                <div class="col-lg-6" style="background-size: cover; background-repeat: no-repeat;">
                                    ...
                                    <div class="sw-price wow fadeInUp animated"
                                        ...
                                        <div class="d-price"
                                            style="background-size: cover; background-repeat: no-repeat;">
                                            <span class="d-val"><?php echo e($game->gamePrice); ?></span>
                                    ...
                                    <a class="btn-main mb10" href="<?php echo e($game->gameRentPath); ?>">HEMEN KİRALA</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH E:\Projects\laravel\hostlariz\resources\views/components/Swiper.blade.php ENDPATH**/ ?>